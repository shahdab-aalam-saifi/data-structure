...
public class BubbleSortTest {
	...
	public void testEmptyListElement() throws Exception {
		...
		List<Integer> sortedElements = bubbleSort.sort(unsortedElements, true);
	...
	public void testEmptyArrayElement() throws Exception {
		...
		Integer[] sortedElements = bubbleSort.sort(unsortedElements, true);
	...
	public void testDescendingSort() throws Exception {
		...
		List<Integer> sortedElements = bubbleSort.sort(unsortedElements, false);
		Collections.sort(unsortedElements);
	...
	public void testStringElements() throws Exception {
		...
		List<String> sortedElements = bubbleSort.sort(unsortedElements, false);
		Collections.sort(unsortedElements);
		Collections.reverse(unsortedElements);
	...
	public void testBestCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_N.getComplexity(), bubbleSort.getTimeComplexity(TimeComplexity.BEST));
	}

	@Test
	public void testAverageCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_N_2.getComplexity(), bubbleSort.getTimeComplexity(TimeComplexity.AVERAGE));
	}

	@Test
	public void testWorstCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_N_2.getComplexity(), bubbleSort.getTimeComplexity(TimeComplexity.WORST));
	}

	@Test
	public void testInvalidCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_INVALID.getComplexity(), bubbleSort.getTimeComplexity(null));
	}

	@Test
	public void testSpaceComplexity() throws Exception {
		assertEquals(BigOh.O_1.getComplexity(), bubbleSort.getSpaceComplexity());
	}
