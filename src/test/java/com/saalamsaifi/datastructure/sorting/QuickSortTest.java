...
public class QuickSortTest {
	...
	public void testNullList() throws Exception {
		quickSort.sort((List<Integer>) null, true);
	}

	@Test(expectedExceptions = {
			IllegalArgumentException.class }, expectedExceptionsMessageRegExp = "unsortedElements == null")
	public void testNullArray() throws Exception {
		quickSort.sort((Integer[]) null, true);
	}
	...
	public void testEmptyListElement() throws Exception {
		...
		List<Integer> sortedElements = quickSort.sort(unsortedElements, true);
	...
	public void testEmptyArrayElement() throws Exception {
		...
		Integer[] sortedElements = quickSort.sort(unsortedElements, true);
	...
	public void testDescendingSort() throws Exception {
		...
		List<Integer> sortedElements = quickSort.sort(unsortedElements, false);
		Collections.sort(unsortedElements);
	...
	public void testStringElements() throws Exception {
		...
		List<String> sortedElements = quickSort.sort(unsortedElements, false);
		Collections.sort(unsortedElements);
		Collections.reverse(unsortedElements);
	...
	public void testBestCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_N_LOG_N.getComplexity(), quickSort.getTimeComplexity(TimeComplexity.BEST));
	}

	@Test
	public void testAverageCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_N_LOG_N.getComplexity(), quickSort.getTimeComplexity(TimeComplexity.AVERAGE));
	}

	@Test
	public void testWorstCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_N_2.getComplexity(), quickSort.getTimeComplexity(TimeComplexity.WORST));
	}

	@Test
	public void testInvalidCaseTimeComplexity() throws Exception {
		assertEquals(BigOh.O_INVALID.getComplexity(), quickSort.getTimeComplexity(null));
	}

	@Test
	public void testSpaceComplexity() throws Exception {
		assertEquals(BigOh.O_LOG_N.getComplexity(), quickSort.getSpaceComplexity());
	}
