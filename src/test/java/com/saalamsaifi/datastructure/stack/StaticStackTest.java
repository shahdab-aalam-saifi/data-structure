...
public class StaticStackTest {
	...
	public void setUp() throws Exception {
		stack = new StaticStack<>(MAX_ELEMENT_COUNT);
	...
	@Test(expectedExceptions = {
			UnsupportedOperationException.class }, expectedExceptionsMessageRegExp = "Stack is overflow")
	public void testStackIsOverflow() throws Exception {
		for (int i = 0; i <= MAX_ELEMENT_COUNT; i++) {
			stack.push(RandomUtils.nextInt());
		}
	}
